...
# Get computer name from system
system_hostname = socket.gethostname()

# Prompt for computer name with system default
computer_name = prompt_for_string("Computer name", system_hostname)
...
if __name__ == "__main__":
    # Write instrument.json to current directory
    output_path = Path("instrument.json")
