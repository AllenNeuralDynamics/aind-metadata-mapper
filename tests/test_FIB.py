...
class TestSchemaWriter(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.example_experiment_data = {
            'labtracks_id': '000000',
            'experimenter_name': ['Lucas Kinsey', 'Kenta Hagihara'],  # Travis Ramirez
            'notes': 'brabrabrabra....',  #
            ...
            'rig_id': 'ophys_rig',
            'COMPort': 'COM3',
            'light_source': ['470nm LED', '415nm LED', '565nm LED'],  # default light source
            'light_excitation_power': [0.020, 0.020, 0.020],  # mW    Set 0 for unused StimLED
